...
namespace user_send_microservice
{
    class Program
    {
        ...
        {
            string ServiceBusConnectionString = "Endpoint=sb://temp-bus-service.servicebus.windows.net/;SharedAccessKeyName=send-key;SharedAccessKey=S5u/7oNOQSHq5qBmRIQZhYMrYpSQVmxMMcELdrxdoVo=;";
